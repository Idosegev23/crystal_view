...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-32 bg-gradient-to-br from-crystal-dark via-gray-900 to-crystal-dark">
        ...
        <div className="container-max">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
              variants={fadeInLeft}
              className="bg-gradient-to-br from-crystal-dark to-gray-900 p-8 lg:p-12 rounded-2xl glass-effect"
            >
